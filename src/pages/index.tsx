    ...
    <Layout>
      <div className='flex w-full h-full'>
        <div className='w-full h-screen flex flex-col gap-y-20 justify-center items-start bg-amber-400 p-10'>
          ...
          <button className='bg-amber-600 hover:bg-amber-700 rounded-md text-center p-3' onClick={() => router.push('/auth')}>Belanja Sekarang</button>
        </div>

        <div className='w-full h-screen flex items-center justify-center'>
          <img src='https://i.pinimg.com/736x/69/9e/63/699e632ee8a0e8eb0be76f42bd7adc55.jpg'
          className='w-80 h-80 rounded-mg'></img> 
        </div>
      </div>
    </Layout>
  )
